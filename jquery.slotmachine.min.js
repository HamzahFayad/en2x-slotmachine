...
!(function (a, b, c, d) {
  function e(b, c) {
    var d = void 0;
    return (
      a.data(b[0], "plugin_" + f)
        ? (d = a.data(b[0], "plugin_" + f))
        : ((d = new p(b, c)), a.data(b[0], "plugin_" + f, d)),
      d
    );
  }
  var f = "slotMachine",
    ...
    p = (function () {
      function c(b, d) {
        _classCallCheck(this, c),
          ...
          (this.$container = this.$tiles
            .wrapAll('<div class="slotMachineContainer" />')
            .parent()),
          ...
          this.settings.auto !== !1 &&
            (this.settings.auto === !0 ? this.shuffle() : this.auto());
      }
      return (
        _createClass(c, [
          {
          ...
          },
          {
            ...
            value: function () {
              return (
                this.futureActive > this.active &&
                0 === this.active &&
                this.futureActive === this.$tiles.length - 1
              );
            },
          },
          {
          ...
          },
          {
            key: "resetPosition",
            value: function (a) {
              this.$container.toggleClass(h),
                this._animate(a === d ? this.direction.initial : a),
          ...
          },
          {
            ...
            value: function (a, b) {
              ...
              if (
                ...
                (this.running = !0),
                this.visible || this.settings.stopHidden !== !0)
              ) {
                ...
                (this.delay = d),
                  ...
                  this.raf(function () {
                    if (!c.stopping && c.running) {
                      var d = a - 1;
                      c.resetPosition(c.direction.first),
                        1 >= d ? c.stop(b) : c.shuffle(d, b);
                    }
                  }, d);
              } else this.stop(b);
          ...
          },
          {
            ...
            value: function (a) {
              ...
              (this.running = !0),
                (this.stopping = !0),
                null === this.futureActive && (this.futureActive = this.custom),
              ...
              return (
                ...
                this.raf(function () {
                  (b.stopping = !1),
                    (b.running = !1),
                    (b.futureActive = null),
                    "function" == typeof b.settings.complete &&
                      b.settings.complete.apply(b, [b.active]),
                    "function" == typeof a && a.apply(b, [b.active]);
                }, c),
                this.active
              );
            },
          },
          {
            ...
            value: function () {
              var a = this;
              this.running ||
                (this._timer = new o(function () {
                  "function" != typeof a.settings.randomize &&
                    (a.settings.randomize = function () {
                      return a._nextIndex;
                    }),
                    a.visible || a.settings.stopHidden !== !0
                      ? a.shuffle(
                          a.settings.spins,
                          a._timer.reset.bind(a._timer)
                        )
                      : a.raf(a._timer.reset.bind(a._timer), 500);
                }, this.settings.auto));
            },
          },
          {
          ...
          },
          {
            ...
            set: function (a) {
              (this._active = a),
                (0 > a || a >= this.$tiles.length) && (this._active = 0);
            },
          },
          {
            key: "visibleTile",
          ...
          },
          {
            ...
            get: function () {
              var c = a(b),
                ...
                e =
                  c.scrollTop() > this.$slot.height() + this.$slot.offset().top;
              return !d && !e;
            },
          },
          {
          ...
          },
          {
            ...
            set: function (a) {
              ...
              this.raf(
                function () {
                  (this._fxClass = a),
                    a === n ? c.removeClass(m) : c.addClass(m);
                }.bind(this),
                b
              );
            },
